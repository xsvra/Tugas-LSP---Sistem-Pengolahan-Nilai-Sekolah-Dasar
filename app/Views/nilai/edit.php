...
<div class="form-container">
    <div class="form-card">
        <div style="display: flex; align-items: center; gap: 0.5rem; margin-bottom: 2rem;">
            ...
            <h3 class="section-title" style="margin: 0;">Edit Nilai Siswa</h3>
        </div>
        ...
        <form action="<?= base_url('/nilai/update/' . $nilai['id']) ?>" method="post">
            ...
            <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 1rem;">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="nilai_tugas" id="nilai_tugas" class="form-control <?= (isset($session_errors['nilai_tugas'])) ? 'is-invalid' : '' ?>" value="<?= old('nilai_tugas', $nilai['nilai_tugas']) ?>" min="0" max="100" step="0.01" required>
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="nilai_uts" id="nilai_uts" class="form-control <?= (isset($session_errors['nilai_uts'])) ? 'is-invalid' : '' ?>" value="<?= old('nilai_uts', $nilai['nilai_uts']) ?>" min="0" max="100" step="0.01" required>
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="nilai_uas" id="nilai_uas" class="form-control <?= (isset($session_errors['nilai_uas'])) ? 'is-invalid' : '' ?>" value="<?= old('nilai_uas', $nilai['nilai_uas']) ?>" min="0" max="100" step="0.01" required>
